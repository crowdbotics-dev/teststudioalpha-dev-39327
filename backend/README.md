...
## Project Structure
    ...
    ├── teststudioalpha_dev_39327  # Django project configurations
...
1. Clone this repo and `cd teststudioalpha_dev_39327`
...
2. Clone this repo and `cd teststudioalpha_dev_39327`
